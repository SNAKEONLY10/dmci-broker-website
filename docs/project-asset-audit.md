...
| 3 | The Erin Heights | `the-erin-heights` | Present | Present | 3/3 present + extras | Present | Present | Embedded Google map + directions | `complete` | `full customer-ready detail added, Drive extras optimized` | [DMCI Homes](https://www.dmcihomes.com/the-erin-heights) |
