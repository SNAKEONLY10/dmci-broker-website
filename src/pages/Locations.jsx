  ...
  return (
    <section className="page-section soft">
      <div className="container">
        <SectionHeader as="h1" align="left" eyebrow="Locations" title="Explore DMCI Projects by Location" text="Choose a city or area, then request the latest computation from Luisa." />
